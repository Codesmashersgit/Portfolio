...
//           <input type="text" placeholder="Your Name" className="w-full mb-4 p-2 rounded text-black outline-none" />
//           <input type="email" placeholder="Your Email" className="w-full mb-4 p-2 rounded text-black outline-none" />
//           <textarea placeholder="Your Message" className="w-full mb-4 p-2 rounded outline-none" rows="4"></textarea>
...
const Contact = () => {
  ...
  const [state, handleSubmit] = useForm("xovalbwa");
